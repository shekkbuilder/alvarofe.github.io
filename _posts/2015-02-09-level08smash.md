...
Write a shellcode is a difficult task in which I have to go deeper. This exercise have been very helpful to understand the danger of vtable on C++ and how the classes are represented in memory. We must be careful when we develop software you never know where the danger resides.
